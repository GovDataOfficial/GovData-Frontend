...
import { MetadataFormStickyNavigationItem } from "@/app/datenpflege/metadaten/_components/MetadataForm/stickNav/partials/MetadataFormStickyNavigationItem";
...
export function MetadataFormStickyNavigation({
  ...
  return (
    <nav
      className="sticky-form-navigation"
