...
export const extractTags = (formData: FormData) => {
  const tags = formData.get(METADATA_FORM_INPUTS.TAGS) as string;
...
export function convertMetadataFormData(
  ...
  result[METADATA_FORM_INPUTS.TAGS] = extractTags(formData);
